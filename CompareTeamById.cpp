...
bool CompareTeamById::isLeftSmaller(std::shared_ptr<Team> &team, int currentId, bool mode)
{
    return team->teamID < currentId;
}

bool CompareTeamById::isLeftSmaller(std::shared_ptr<Team> &team, std::shared_ptr<Team> &currentTeam, bool mode)
{
